...
export default BaseCls => class extends BaseCls {
  ...
  static registerCallback(callbackName) {
    Object.defineProperty(this, callbackName, { value(...args) { this.addCallback(callbackName, ...args) } })
    Object.defineProperty(this.prototype, callbackName, { value(...args) { this.addCallback(callbackName, ...args) } })
  }
